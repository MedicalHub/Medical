ReactiveSunburst = function (options) {
	...
	var sunburst = $("#" + options.id);
	console.info(sunburst);
	...
	var tooltip = d3.select("#" + options.id).append("div").attr("id", "tooltip").style("position", "absolute").style("z-index", "10").style("opacity", 0);
...
ReactiveSunburst.prototype.update = function () {
